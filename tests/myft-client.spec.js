...
describe('Initialising', function() {
	...
	it('in erights mode exits if erights absent from cookie', function(done) {
		document.cookie = 'FT_U=_PID=4011101642_TIME=%5BWed%2C+04-Mar-2015+11%3A49%3A49+GMT%5D_RI=0_I=0_';
	...
	it('in erights mode sets userId from the cookie', function(done) {
		...
		.then(function () {
			expect(myFtClient.userId).to.equal('User:erights-12324');
			expect(myFtClient.notifications).to.exist;
			done();
		});
